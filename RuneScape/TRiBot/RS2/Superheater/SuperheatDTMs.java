...
public class SuperheatDTMs {
	...
	public DTM ironDTM(){
		// Iron
		DTMPoint DTM_PT_2 = new DTMPoint(new Color(52, 31, 23), new Tolerance(10, 10, 10));
		DTMSubPoint [] DTM_PTS_2 = { new DTMSubPoint(new ColourPoint(new Point(-10, 2), new Color( 97, 77, 54)), new Tolerance(10, 10, 10),1), new DTMSubPoint(new ColourPoint(new Point(8, 6), new Color( 55, 32, 24)), new Tolerance(10, 10, 10),1)};
	...
	public DTM coalDTM(){
		// Coal
		DTMPoint DTM_PT_4 = new DTMPoint(new Color(35, 35, 27), new Tolerance(10, 10, 10));
		DTMSubPoint [] DTM_PTS_4 = { new DTMSubPoint(new ColourPoint(new Point(-11, 3), new Color( 97, 77, 54)), new Tolerance(10, 10, 10),1), new DTMSubPoint(new ColourPoint(new Point(7, 7), new Color( 35, 35, 27)), new Tolerance(10, 10, 10),1)};
