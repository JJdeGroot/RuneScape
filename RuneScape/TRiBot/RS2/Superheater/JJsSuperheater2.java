...
@ScriptManifest(authors = { "J J" }, category = "Magic", name = "JJ's Superheater V2")
public class JJsSuperheater2 extends Script implements Painting{
	...
	final boolean  useCoalbag = true;  // true or false
	final String bankMode = "Chest";  // "Banker" , "Bank", "Chest"
	final String bar = "Bronze";         // "Bronze", "Iron", "Silver", "Steel", "Gold", "Mithril", "Adamant", "Rune"
	final String style = "Fast";	   // "Random", "Fast"
	int ores = 2,
		superheats = 0;
	...
	public void onPaint(Graphics g){
        ...
        g.drawString("JJ's Superheater", 5, 160);
        g.drawString("Superheats: " + superheats, 5, 175);
        g.drawString("Per hour: " + toHour(superheats), 5, 190);
    }
