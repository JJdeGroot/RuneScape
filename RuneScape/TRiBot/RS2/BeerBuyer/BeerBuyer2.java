...
public class BeerBuyer2 extends Script implements Painting{
	...
	private void buyBeers(){
		...
		if (talkingToKaylee()){
			...
			space();
			if (waitChatOption("dwarves", 2000)){
				Keyboard.typeString("1");
				if (waitContinue(1000)){
					space();
					if (waitChatOption("Asgarnian", 2000)){
						space();
						if (waitChatOption("feel", 2000)){
							Keyboard.typeString(choice);
							if (waitContinue(2000)){
								space();
								beers++;
							}
						}
			...
			if (waitChatOption("ales are", 2000)){
				Keyboard.typeString("1");
				if (waitContinue(2000)){
					space();
					if (waitChatOption("Asgarnian", 2000)){
