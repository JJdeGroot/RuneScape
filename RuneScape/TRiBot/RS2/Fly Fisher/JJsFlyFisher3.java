...
import org.tribot.script.interfaces.Painting;
    ...
    public class JJsFlyFisher3 extends Script implements Painting {
    	...
    	private int e, xOffset, yOffset;
    	long animationID, StartTime = 0;
        ...
        public void onPaint(Graphics g) {
            ...
            g.drawString("Animation ID: " + animationID, 5, 140);
            g.drawString("Status: " + status, 5, 160);
        }
        
        private void getAnimationID() {
        	status = "Grabbing animation id";
